    ...
    <div class="container mx-auto px-4 -mt-24">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-xl shadow-lg p-6 md:p-8 lg:p-10 transform transition-all duration-300 hover:shadow-xl">
                    <!-- Avatar Section -->
                    <div class="flex flex-col items-center mb-4">
                        ...
                        <div class="mt-4 text-center">
                            <h1 class="text-lg md:text-lg lg:text-2xl font-bold text-gray-900">{{ auth()->user()->fname }} {{ auth()->user()->lname }}</h1>
                            <p class="text-sm md:text-base lg:text-md text-gray-600 capitalize">{{ auth()->user()->role}}</p>
                        </div>
                    </div>
                    ...
                    <div class="space-y-3 md:space-y-4 lg:space-y-5 text-gray-700">
                        ...
                        <div class="flex items-center gap-2 md:gap-3">
                            <span class="material-icons text-blue-600 text-sm md:text-base lg:text-lg">location_on</span>
                            <div class="text-left text-xs md:text-sm lg:text-base">
                                <p>{{ $location }}</p>
                            </div>
                        </div>
                ...
                <div class="bg-white rounded-xl shadow-lg p-6 md:p-8 lg:p-10 transform transition-all duration-300 hover:shadow-xl">
                    <div class="space-y-4 md:space-y-6 lg:space-y-8">
                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200 text-xs md:text-sm lg:text-base">
                                <thead>
                                    <tr class="bg-gray-50">
                                        <th class="px-4 py-2 md:px-6 md:py-3 text-left font-semibold text-gray-700 uppercase tracking-wide">Date</th>
                                        <th class="px-4 py-2 md:px-6 md:py-3 text-left font-semibold text-gray-700 uppercase tracking-wide">Clock In</th>
                                        <th class="px-4 py-2 md:px-6 md:py-3 text-left font-semibold text-gray-700 uppercase tracking-wide">Clock Out</th>
                                    </tr>
                                </thead>
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <tr class="hover:bg-gray-50 transition-colors">
                                        <td class="px-4 py-2 md:px-6 md:py-3 text-gray-900">01 - Dec - 2024</td>
                                        <td class="px-4 py-2 md:px-6 md:py-3 text-gray-900">
                                            <div class="flex items-center space-x-2">
                                                <span class="material-icons text-green-500 text-sm md:text-base lg:text-lg">call_received</span>
                                                <span>3:00 AM</span>
                                            </div>
                                        </td>
                                        <td class="px-4 py-2 md:px-6 md:py-3 text-gray-900">
                                            <div class="flex items-center space-x-2 ">
                                                <span class="material-icons text-red-500 text-sm md:text-base lg:text-lg">call_made</span>
                                                <span>4:00 PM</span>
                                            </div>
                                        </td>
                                    </tr>
